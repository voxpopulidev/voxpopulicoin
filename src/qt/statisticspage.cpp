...
void StatisticsPage::updateStatistics()
{
    ...
    else if (pindexBest->nHeight <= 21600)
    {
      nSubsidy = 500; 
    }
    ...
    if (pindexBest->nHeight <= 5760)
    {
        phase = "Initial Coin offer";
    }
    else if (pindexBest->nHeight <=12960)
    {
        phase ="Pow With 750 reward";
    }
    else if (pindexBest->nHeight <= 21600)
    {
        phase = "Pow With 500 Reward";
    }
    else if (pindexBest->nHeight > 21600)
    {
       phase ="POS Period";
    ...
    {
        ui->volumeBox->setText("<b><font color=\"green\">" + qVolume + " arn" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " arn" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " arn");
    }
